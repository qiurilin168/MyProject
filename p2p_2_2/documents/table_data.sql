...
CREATE TABLE `media` (
  ...
  PRIMARY KEY (`mid`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='媒体报道表';
...
CREATE TABLE `rolejur` (
  ...
  PRIMARY KEY (`rjid`)
) ENGINE=InnoDB AUTO_INCREMENT=597 DEFAULT CHARSET=utf8 COMMENT='角色权限表';
...
CREATE TABLE `skb` (
  ...
  `date` datetime DEFAULT NULL COMMENT '日期',
  `baid` int(11) DEFAULT NULL COMMENT '借款id',
  `state` int(11) DEFAULT NULL COMMENT '收款状态，0未还款，1已还款，2已收款',
  PRIMARY KEY (`skid`)
